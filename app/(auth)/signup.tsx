...
export default function SignupScreen() {
  ...
  const canSubmit = isValidEmail(email) && isStrongPassword(password) && !submitting;
  ...
  const onSubmit = useCallback(async () => {
    ...
    if (result.kind === 'confirmation_required') {
      Alert.alert(
        'Casi listo',
        `Te hemos enviado un email a ${result.email}. Confírmalo desde tu bandeja de entrada para entrar.`,
        [
          {
            text: 'Entendido',
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F7F7FC' }} edges={['top', 'bottom']}>
      ...
      >
        ...
        >
          ...
          >
            Guarda tu racha y tus píldoras en tu cuenta para no perderlas si cambias de móvil.
          </Text>
