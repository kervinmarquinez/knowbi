...
- title gramaticalmente impecable y natural: debe sonar como lo escribiría un periodista nativo, no como una traducción literal. Verifica la concordancia sujeto-verbo y de género/número — el verbo de una oración de relativo concuerda con su antecedente ("el queso que madura", no "el queso que maduran"). Evita construcciones elípticas agramaticales del tipo "por + adjetivo" sin verbo: escribe "por ser demasiado peligroso", nunca "por demasiado peligroso". Reléelo en voz alta antes de devolverlo: si suena forzado, ambiguo o raro, reescríbelo.
